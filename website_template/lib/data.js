...
export const TEAM = [
  {
    id: "founder-1",
    name: "Robel Yoseph",
    role: "Co-Founder · Server + Web Development",
    affiliation: "B.S. Physics",
    bio: "Interested in the intersection between Theoretical Physics and Artificial Intelligence with a keen passion for Astrophysics and Quantitative Finance. ",
    image: "/Robel.jpg",
